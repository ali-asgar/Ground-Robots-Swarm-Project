 ...
 *
 * Program Name: MoveAllDirections.ino
...
void loop() {
    ...
    if(i == 'a' || i == 'A') {  // The robot moves left
    roboclaw.ForwardM1(address,25);
    roboclaw.ForwardM2(address,48);
    delay(10);
    }
    if(i == 's' || i == 'S') {  // The robot moves back
    roboclaw.BackwardM1(address,25);
    roboclaw.BackwardM2(address,24);
    delay(10);
    }
    if(i == 'd' || i == 'D') {  // The robot moves right
    roboclaw.ForwardM1(address,49);
    roboclaw.ForwardM2(address,24);
    delay(10);
    }
    if(i == 'z') {
    roboclaw.BackwardM1(address,25); //Zero point rotation
    roboclaw.ForwardM2(address,24);
    delay(10);
    }
