 ...
 *               
 * Purpose of this file: to move the robot in according to SLAM Algorithm
 * Program 8
 * 
 */
...
void loop() {    
    ...
    if(i == 'm') {
    roboclaw.ForwardM1(address,25);
    roboclaw.ForwardM2(address,48);
    delay(10);
    }
    if(i == 'b') {
    roboclaw.BackwardM1(address,25);
    roboclaw.BackwardM2(address,24);
    delay(10);
    }
    if(i == 'l') {
    roboclaw.ForwardM1(address,49);
    roboclaw.ForwardM2(address,24);
    delay(10);
    }
    if(i == 'z') {
    ...
    {
      //int encLeft = (int16_t)(enc1 & 0xFFFF);
      //int encRight = (int16_t)(enc2 & 0xFFFF);
      //int k = 0;
      float heading = 000.0;
      sprintf(buff, "%03d%011ld%011ld", (int)heading, enc1, enc2);
      Serial.println(buff);
      delay(10);
    }
    displayspeed();
