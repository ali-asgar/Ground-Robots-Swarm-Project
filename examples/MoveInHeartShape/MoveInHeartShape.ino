 ...
 *               
 * Purpose of this file: to move the robot in a heart shape
 * Program 7
 * 
 */
...
void loop() {    
    ...
    if(enc1 > theta && enc1 <= (theta + radius))  {
       roboclaw.ForwardM1(address,s1);
       roboclaw.ForwardM2(address,s2);
    }
    if(enc1 > (theta + radius) && enc1 <= ((5.5)*theta + radius)) {
        roboclaw.BackwardM1(address,s1);
        roboclaw.ForwardM2(address,s2);
    }
    if(enc1 > (5.5*theta + radius) && enc1 <= (6*theta + 2*radius))  {
       roboclaw.ForwardM1(address,s1);
       roboclaw.ForwardM2(address,s2);
    }    
    if(enc1 > (6*theta + 2*radius) && enc1 <= (6*theta + 2*radius)) {
        roboclaw.BackwardM1(address,s1);
        roboclaw.ForwardM2(address,s2);
    }    
    if(enc1 > ((6)*theta + 2*radius) && enc1 <= ((6)*theta + 2*radius + 3.14*2000)) {
        roboclaw.ForwardM1(address,s3);
        roboclaw.ForwardM2(address,s4);
    }
    if(enc1 > ((6)*theta + 2*radius + 3.14*2000) && enc1 <= ((12)*theta + 2*radius + 3.14*2000)) {
        roboclaw.BackwardM1(address,s1);
        roboclaw.ForwardM2(address,s2);
    }
    if(enc1 > ((12)*theta + 2*radius + 3.14*2000) && enc1 <= ((12)*theta + 2*radius + 2*3.14*2000)) {
        roboclaw.ForwardM1(address,s3);
        roboclaw.ForwardM2(address,s4);
    }    
    if(enc1 > (12*theta + 2*radius + 2*3.14*2000)) {
